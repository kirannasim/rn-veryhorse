        ...
        return (
            <View style={style.form}>
                <View style={style.formgroup}>
                    <Text style={style.label}>{intlData.messages[this.props.param1 == "pickCity"?'STARTING_POINT':'POINT_ARRIVAL']} *:</Text>
                    <View style={{flex:1}}>
                ...
                <View style={style.formgroup}>
                    ...
                    <TextInput style={style.input} keyboardType="numeric" value={this.props.data[this.props.param2]} onChangeText={(text)=>this.props.handleChange(this.props.param2,text)}></TextInput>
                    {
